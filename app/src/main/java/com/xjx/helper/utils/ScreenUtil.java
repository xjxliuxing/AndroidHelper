...
public class ScreenUtil {
    ...
    public ScreenUtil() {
        //得到屏幕窗口管理器
        WindowManager windowManager = (WindowManager) App.getInstance().getContext().getSystemService(Context.WINDOW_SERVICE);
        // 屏幕信息（宽度、密度、字体）
    ...
    public int getstatusBarHeight() {
        ...
        if (resourceId > 0) {
            //根据资源ID获取响应的尺寸值
            statusBarHeight = App.getInstance().getContext().getResources().getDimensionPixelSize(resourceId);
        }
