package com.xjx.helper.widget.animation;
...
public class CustomRadialGradientView extends View {
    ...
    public CustomRadialGradientView(Context context) {
        super(context);
        initView(context, null);
    }
    
    public CustomRadialGradientView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
