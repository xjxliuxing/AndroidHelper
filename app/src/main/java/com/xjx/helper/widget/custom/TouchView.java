...
public class TouchView extends View {
    private final long waitTime = 1000; // 长按的等待时间
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        mBitmap = CustomViewUtil.getBitmapDefault(drawable);
        // 设置bitmap的数据
        if (mBitmap != null) {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mPaint.setColor(ContextCompat.getColor(getContext(), R.color.black_15));
